 ...
 * @Author: yangmengnan
 * @Date:   2019-03-07 14:36:30
 * @Last Modified 2019-03-07
 */
class Tools_GeoCoordinate
{
    ...
    /**
     * gps wgs-84坐标转为 百度bd-09坐标
     *
     * 使用工具 \tekintian\geo_utils\GeoCoordinate
     * @param  [type] $bd_lat [gps纬度]
     * @param  [type] $bd_lng [gps经度]
     * @return [array]      [bd-09经纬度坐标数组]
     */
    public function gpsToBd09($gps_lat, $gps_lng)
    {
        $_gcj=$this->gpsToGcj02($gps_lat, $gps_lng);
        $gps=$this->gcj02ToBd09($_gcj['lat'],$_gcj['lng']);
        return $gps;
    }
    /**
